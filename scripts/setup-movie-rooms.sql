-- Complete movie rooms setup script
-- Run this script in your Supabase SQL editor to set up the movie room functionality

-- 1. Create the movie rooms schema (from 009_create_movie_rooms.sql)
